...
class RouteTestSliceServiceProvider extends SliceServiceProvider
{
...
class ViewTestSliceServiceProvider extends SliceServiceProvider
{
    public function configure(Slice $slice): void
    {
...
class TranslationTestSliceServiceProvider extends SliceServiceProvider
{
    public function configure(Slice $slice): void
    {
...
class MigrationTestSliceServiceProvider extends SliceServiceProvider
{
    public function configure(Slice $slice): void
    {
